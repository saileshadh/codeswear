...
const Post = ({ Buy, product, addToCart }) => {
    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://m.media-amazon.com/images/I/51hY+wSFsSL._AC_SX679_.jpg" />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">Clothes</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">T-shirt</h1>
            ...
            <div className="flex">
              <span className="title-font font-medium text-2xl text-gray-900">Rs.899</span>
              <button onClick={() =>
                Buy(
                  slug,
                  1,
                )
              } className="flex ml-auto text-white bg-blue-600 border-0 py-2 px-6 focus:outline-none hover:bg-blue-800 rounded">Buy</button>
              <button
                onClick={() => addToCart(slug, 1, 899, 'T-shirt',)
                }
                className="flex ml-auto text-white bg-blue-600 border-0 py-2 px-2 focus:outline-none hover:bg-blue-800 rounded"><AiFillShopping className="text-xl mx-1 hidden md:flex" />Add
                  to Cart</button>
